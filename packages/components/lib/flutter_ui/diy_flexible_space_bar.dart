...
/// [DiyFlexibleSpaceBar.createSettings], to convey sizing information down to the
/// [DiyFlexibleSpaceBar].
///
/// {@tool dartpad}
/// This sample application demonstrates the different features of the
/// [DiyFlexibleSpaceBar] when used in a [SliverAppBar]. This app bar is configured
/// to stretch into the overscroll space, and uses the
/// [DiyFlexibleSpaceBar.stretchModes] to apply `fadeTitle`, `blurBackground` and
...
class _DiyFlexibleSpaceBarState extends State<DiyFlexibleSpaceBar> {
